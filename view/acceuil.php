...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.html"><img src="../assets/front/images/logo.svg" alt="alternative"></a>
                ...
                <div class="col-md-2">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg white">
                            ...
                            <li>
                                <a class="white" href="../assets/front/terms-conditions.html">Terms & Conditions</a>
                            </li>
                            <li>
                                <a class="white" href="../assets/front/privacy-policy.html">Privacy Policy</a>
                            </li>
                        </ul>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
    ...
    <script src="../assets/front/js/morphext.min.js"></script> <!-- Morphtext rotating text in the header -->
