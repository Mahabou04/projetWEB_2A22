            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <form id="callMeForm" data-toggle="validator" data-focus="false">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control-input" id="lpassword" name="lpassword" required>
                        ...
                        <div class="form-group ">
                            <p class="white"><a class="white" href="privacy-policy.html">Create new account </a></p>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                            <button type="submit" class="form-control-submit-button">connection</button>
                        </div>
