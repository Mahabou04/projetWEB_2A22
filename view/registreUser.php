...
session_start();
    ...
    if (
        ...
        if (
            ...
            $ajout=$userC->inscriptionuser($user);
            if($ajout=='compte cree'){
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="connecterUser.php">CONNECTER</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="registreUser.php">REGISTRER</a>
                </li>
    ...
    <div id="registre" class="form-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        <div class="section-title">REGISTRER</div>
                ...
                <div class="col-lg-6">
                    ...
                    <form  data-toggle="validator" data-focus="false" method='POST'>
                        <div class="form-group">
                            <input type="text" class="form-control-input" id="nom" name="nom" required>
                            <label class="label-control" for="nom">Nom</label>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control-input" id="prenom" name="prenom" required>
                            <label class="label-control" for="prenom">Prenom</label>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                            <input type="date" class="form-control-input" id="dateN" name="dateN" required>
                            <label class="label-control" for="dateN"></label>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group checkbox white">
                            <input type="checkbox" id="lterms" value="Agreed-to-Terms" name="lterms" required>I agree with Aria's stated <a class="white" href="privacy-policy.html">Privacy Policy</a> and <a class="white" >Terms & Conditions</a>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                            <button type="submit" class="form-control-submit-button">REGISTRER</button>
                        </div>
