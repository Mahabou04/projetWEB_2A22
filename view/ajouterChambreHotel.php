...
if (
    ...
    if (
        ...
        header('Location:afficherchambrehotel.php?idh='.$_GET["id_hotel"]);
    } else {
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Ajouter chambre</h1>
                            </div>
                        ...
                        <?php echo $error; ?>
                            ...
                            <form class="user" method="POST">
                                ...
                                <input type="submit" value=" ajouter chambre" class="btn btn-primary btn-reservation btn-block"> 
                            </form>
                            <hr>
                            <div class="text-center">
    <a class="small" href="afficherchambrehotel.php?idh=<?php echo $_GET['id_hotel']?>">Retour à la liste des chambre</a>
        </div>  
