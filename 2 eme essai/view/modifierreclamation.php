...
<body class="bg-gradient-primary">
		...
		<?php
			if (isset($_GET['id'])){
				$reclamation = $reclamationC->recupererreclamation($_GET['id'],'id');
            }
                    ...
                    <form class="user" method="POST">
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" class="form-control form-control-user" name="contact" id="contact"
                                    ...
                                    value="<?php echo $reclamation['contact']; ?>">
                            </div>
                            <div class="col-sm-6">
                                <input type="text" class="form-control form-control-user" id="type"
                               name="type"  placeholder="type :" max="999" value="<?php echo $reclamation['type']; ?>"
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                value="<?php echo $reclamation['destinataire']; ?>"
                                >
                            </div>
                            <div class="col-sm-6">
                                <input type="text" class="form-control form-control-user"
                               name="statut" id="statut" placeholder="statut :" 
                               value="<?php echo $reclamation['statut']; ?>"
                               >
                            </div>
                        </div>
                        <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            name="description" placeholder="description :" value="<?php echo $reclamation['description']; ?>">
                                </div>
                        ...
                        <input type="submit" value=" Modifer reclamation" class="btn btn-primary btn-user btn-block"> 
                    </form>
                    <hr>
                            <div class="text-center">
