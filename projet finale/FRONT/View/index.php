...
<body data-spy="scroll" data-target=".fixed-top">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h2>Articles  </h2>
                         ...
                         <p class="p-heading"> <?php 
                        require_once 'compteur/compteurr.php';
                         ajouter_vue(); ?>
                         <H6>Nombre de vue</H6> <i class="fa fa-eye" ><?= nombre_vue();?></i></p>
			...
			?>
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p  class="testimonial-author"><a href="privacy-policy.php?id=<?PHP echo $article['id_article']; ?> "><?PHP echo $article['titre']; ?> </a></p>
                                            <br>
    ...
    <div id="project-8" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <p>By offering the best professional services and quality products in the market. Don't hesitate and get in touch with us.</p>
                <div class="testimonial-container">
                    <p class="testi.monial-text">Need a solid foundation for your business growth plans? Aria will help you manage sales and meet your current requirements.</p>
                    <p class="testimonial-author">General Manager</p>
                </div>
                <a class="btn-solid-reg" href="#your-link">DETAILS</a> <a class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a> 
            </div> <!-- end of col -->
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">Ranim <a href="https://inovatik.com">Groupe 3</a></p>
                </div> <!-- end of col -->
            </div> <!-- enf of row -->
        </div> <!-- end of container -->
...
<div class="testimonial-author">Ranim Mediouni</div>