<?php
    ...
    if (
        ...
        if (
            ...
            $ticketC->modifierticket($ticket,$_GET['id']);
...
<body class="bg-gradient-primary">
		...
		<?php
			if (isset($_GET['id'])){
				$ticket = $ticketC->recupererticket($_GET['id'],"id");
            }
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Modifier ticket</h1>
                            </div>
                    ...
                    <?php echo $error; ?>
                            ...
                            <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        value="<?php echo $ticket['id_reservation']; ?>" max="999" placeholder="id_reservation"
                             ...
                             <div class="form-group row">
                                    <div class="col-sm-6">
                                        ...
                                        value="<?php echo $ticket['prix']; ?>" name="prix"  placeholder="prix"
                                        onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'">
                                ...
                                <input type="submit" value=" Modifer ticket" class="btn btn-primary btn-user btn-block"> 
                            </form>
                            <hr>
                            <div class="text-center">
