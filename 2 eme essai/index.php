    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#contact">RECLAMATION</a>
                </li>
            </ul>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <p>You can stop by our office for a cup of coffee and just use the reclamation form below for any questions and inquiries</p>
                ...
                <div class="col-lg-6">
                    ...
                    <form id="contactForm" data-toggle="validator" data-focus="false" method="POST" action="">
                        <div class="form-group">
                            ...
                            <label class="label-control" for="cname" >Contact </label>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control-input" id="type" name="type" required>
                            <label class="label-control" for="cemail" >Type</label>
                            <div class="help-block with-errors"></div>
                        </div>

                        <div class="form-group">
                            <input type="text" class="form-control-input" id="destinataire"  name="destinataire" required>
                            <label class="label-control" for="cemail" >Destinataire</label>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control-input" id="statut" name="statut" required>
                            <label class="label-control" for="cemail" >Statut</label>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control-textarea" id="description" name="description" required></textarea>
                            <label class="label-control" for="cmessage" >Your message</label>
                            <div class="help-block with-errors"></div>
                        </div>
                        
                        <div class="form-group">
                            <input  type="submit" class="form-control-submit-button" value="SUBMIT RECLAMATION">
                        </div>
                        <div class="form-message">
