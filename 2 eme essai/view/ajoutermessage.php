<?php
    ...
    if (
        ...
        if (
            ...
            $ajout=$messageC->ajoutermessage($message);
            if($ajout){
        ...
        $error = "Reclamation n'existe pas";
    }
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Ajouter message</h1>
                            </div>
                        ...
                        <?php echo $error; ?>
                            ...
                            <form class="user" method="POST">
                                 <div class="form-group row"> 
                                    ...
                                    <input type="number" class="form-control form-control-user" name="id_reclamation" id="id_reclamation"
                                            placeholder="Id_reclamation" max="999"
                            ...
                            <hr>
                            <div class="text-center">
    <a class="small" href="affichermessage.php">Retour à la liste des messages</a>
        </div>  
