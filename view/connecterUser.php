...
session_start();
    ...
    if (		
        ...
        if (
            ...
            $con=$userC->connectuser($_POST["email"],$_POST["password"]);
            if($con=="email est incorrect"){
                $error = "email existant"; 
            }
            else if($con=="mot de passe est incorrect"){
                $error="mot de passe est incorrect";
            }
            else{
                $_SESSION['key']=$con;
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <div id="connecter" class="form-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        <div class="section-title">SE CONNECTER</div>
